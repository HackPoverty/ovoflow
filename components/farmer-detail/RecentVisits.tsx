...
function RecentVisits({ farmerId }: { farmerId: string }) {
  const { data, isLoading, error } = useSWR(`/farmer/${farmerId}/@receent`, () => getRecentVisitsByFarmerId(farmerId, PAGE_LIMIT))
...
function Loading() {
  ...
  return <div className="bg-base-200 flex flex-col items-center gap-4 py-4">
